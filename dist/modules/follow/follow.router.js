...
import { toggleFollow, followChannel, getMyFollowedChannels, getUnfollowedChannels, // Add this import
checkFollowStatus, toggleNotifications, getChannelFollowers, } from "./follow.controller.js";
...
/**
 * @route   GET /api/follows/discover
 * @desc    Get channels the user is NOT following (for discovery/recommendations)
 * @access  Private
 */
router.get("/discover", verifyUser, getUnfollowedChannels);
/**
