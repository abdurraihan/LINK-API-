...
import { createVideo, getAllVideos, getVideoById, incrementViewCount, getVideosByChannel, updateVideo, deleteVideo, publishVideo, getTrendingVideos, checkTranscodingStatus, } from "../video/video.controller.js";
...
router.patch("/:videoId", verifyUser, uploadPublic.single("thumbnail"), updateVideo);
